    ...
    <div class="main-content">
        ...
        // echo "<div class='li'";
            ...
            while ($film = $films->fetch()) {
                echo "<a href='index.php?action=detailMovie&id=" . $film["id_film"] . "'>
                        <div class='li-film'>
                                <a href=''  id='delete'><img class src='data:image/png;base64,'></a>       
